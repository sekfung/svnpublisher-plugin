...
public class SVNLogClient17 extends SVNBasicDelegate {
     ...
     */
    public SVNLogClient17(ISVNAuthenticationManager authManager, ISVNOptions options) {
     ...
     *            {@link SVNLogEntry#getChangedPaths()})
     * @param limit
     ...
     * returned.
     * <p/>
     * Refer to {@link SVNLogEntry#hasChildren()} for
     ...
     * {@link SVNDirEntry}object and passed to the
     * <code>handler</code>'s
     * {@link ISVNDirEntryHandler#handleDirEntry(SVNDirEntry)
