...
public class SVNWCClient extends SVNBasicClient {
     ...
     *            {@link SVNProperty#KEYWORDS} property
     ...
     * an error code {@link SVNErrorCode#ILLEGAL_TARGET}
     ...
     * {@link ISVNPropertyValueProvider#providePropertyValues(File, SVNProperties)}
     ...
     * {@link SVNErrorCode#ILLEGAL_TARGET} (if the
     * property is not appropriate for <code>path</code>), or with
     * {@link SVNErrorCode#BAD_MIME_TYPE} (if changed
     ...
     *             or <span class="javastring">"svn:wc"</span> prefix)
     *             </ul>
     * @see #doSetProperty(File, String,
     *      SVNPropertyValue, boolean,
     *      SVNDepth, ISVNPropertyHandler,
     *      Collection)
     * @since 1.2, SVN 1.5
     */
     ...
     *             {@link SVNProperty#SVN_WC_PREFIX
     *             svn:wc:} prefix
