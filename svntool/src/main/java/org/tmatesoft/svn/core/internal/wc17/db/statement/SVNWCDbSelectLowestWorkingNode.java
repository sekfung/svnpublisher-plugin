...
public class SVNWCDbSelectLowestWorkingNode extends SVNSqlJetSelectFieldsStatement<NODES__Fields> {
    ...
    protected void defineFields() {
        fields.add(NODES__Fields.op_depth);
        fields.add(NODES__Fields.presence);
        fields.add(NODES__Fields.kind);
        fields.add(NODES__Fields.moved_to);
    }

    protected boolean isFilterPassed() throws SVNException {
        return getColumnLong(NODES__Fields.op_depth) > (Long) getBind(3);
    }
