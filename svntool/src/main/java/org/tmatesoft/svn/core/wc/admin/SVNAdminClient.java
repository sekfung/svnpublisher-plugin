...
public class SVNAdminClient extends SVNAdminBasicClient {
     ...
     *
     * This implementation uses {@link SVNRepositoryFactory#createLocalRepository(File, String, boolean, boolean)}}.
     * <p>
     ...
     * replication feature (see {@link SVNRepositoryReplicator}})
     *
