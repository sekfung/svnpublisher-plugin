...
public class SVNWCDbInsertTargetDepthFiles extends SVNSqlJetInsertStatement {
    ...
    public long exec() throws SVNException {
        try {
            ...
            while (select.next()) {
            	String localRelPath = select.getColumnString(NODES__Fields.local_relpath);
                String kind =  select.getColumnString(NODES__Fields.kind);
                String parentRelPath = select.getColumnString(NODES__Fields.parent_relpath);
