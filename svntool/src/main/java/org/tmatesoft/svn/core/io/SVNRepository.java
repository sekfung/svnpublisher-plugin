...
public abstract class SVNRepository {
     ...
     * under the specified <code>revision</code>, {@link SVNNodeKind#NONE SVNNodeKind.NONE}
     * will be returned.
	 * 
     * <p>
     ...
     * {@link SVNLogEntry#getChangedPaths()} that returns a map,
     ...
     * {@link SVNLogEntry} object with non-empty
     * {@link SVNLogEntry#getChangedPaths() changed paths map};
     ...
     * 
     * <p/> 
     * Refer to {@link SVNLogEntry#hasChildren()} for additional information on how
