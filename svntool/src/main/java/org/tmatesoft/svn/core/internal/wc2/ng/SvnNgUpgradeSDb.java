...
public class SvnNgUpgradeSDb {
    ...
    {
        SVNSqlJetStatement stmt = new SVNSqlJetSelectFieldsStatement<ACTUAL_NODE__Fields>(sDb, SVNWCDbSchema.ACTUAL_NODE) {
            protected void defineFields() {
                fields.add(ACTUAL_NODE__Fields.wc_id);
                fields.add(ACTUAL_NODE__Fields.local_relpath);
                fields.add(ACTUAL_NODE__Fields.tree_conflict_data);
            }
            protected boolean isFilterPassed() throws SVNException {
                return !isColumnNull(ACTUAL_NODE__Fields.tree_conflict_data);
            }
        };
        ...
        try {
            while (stmt.next()) {
                migrateSingleTreeConflictData(sDb, 
                        stmt.getColumnString(ACTUAL_NODE__Fields.tree_conflict_data),
                        stmt.getColumnLong(ACTUAL_NODE__Fields.wc_id),
                        SVNFileUtil.createFilePath(stmt.getColumnString(ACTUAL_NODE__Fields.local_relpath)));
            }
        } finally {
            stmt.reset();
        }
        ...
        stmt = new SVNSqlJetUpdateStatement(sDb, SVNWCDbSchema.ACTUAL_NODE) {
            public Map<String, Object> getUpdateValues() throws SVNException {
                ...
                rowValues.put(ACTUAL_NODE__Fields.tree_conflict_data.toString(), null);
                return rowValues;
            }
        };
        try {
				...
				*/
	    		SVNSqlJetInsertStatement stmt = new SVNSqlJetInsertStatement(sDb, SVNWCDbSchema.NODES) {
	    		    ...
	    		    protected Map<String, Object> getInsertValues() throws SVNException {
	    		    	...
	    		    	insertValues.put(NODES__Fields.wc_id.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.wc_id.toString()));
	    		    	insertValues.put(NODES__Fields.local_relpath.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.local_relpath.toString()));
	    		    	insertValues.put(NODES__Fields.op_depth.toString(), 0);
	    		    	insertValues.put(NODES__Fields.parent_relpath.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.parent_relpath.toString()));
	    		    	insertValues.put(NODES__Fields.repos_id.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.repos_id.toString()));
	    		    	insertValues.put(NODES__Fields.repos_path.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.repos_path.toString()));
	    		    	insertValues.put(NODES__Fields.revision.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.revnum.toString()));
	    		    	insertValues.put(NODES__Fields.presence.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.presence.toString()));
	    		    	insertValues.put(NODES__Fields.depth.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.depth.toString()));
	    		    	insertValues.put(NODES__Fields.moved_here.toString(), null);
	    		    	insertValues.put(NODES__Fields.moved_to.toString(), null);
	    		    	insertValues.put(NODES__Fields.kind.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.kind.toString()));
	    		    	insertValues.put(NODES__Fields.changed_revision.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.changed_rev.toString()));
	    		    	insertValues.put(NODES__Fields.changed_date.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.changed_date.toString()));
	    		    	insertValues.put(NODES__Fields.changed_author.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.changed_author.toString()));
	    		    	insertValues.put(NODES__Fields.checksum.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.checksum.toString()));
	    		    	insertValues.put(NODES__Fields.properties.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.properties.toString()));
	    		    	insertValues.put(NODES__Fields.translated_size.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.translated_size.toString()));
	    		    	insertValues.put(NODES__Fields.last_mod_time.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.last_mod_time.toString()));
	    		    	insertValues.put(NODES__Fields.dav_cache.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.dav_cache.toString()));
	    		    	insertValues.put(NODES__Fields.symlink_target.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.symlink_target.toString()));
	    		    	insertValues.put(NODES__Fields.file_external.toString(), selectedRow.get(SVNWCDbSchema.BASE_NODE__Fields.file_external.toString()));
	    		    	return insertValues;
	    		    }
	    		...
	    		stmt = new SVNSqlJetInsertStatement(sDb, SVNWCDbSchema.NODES) {
	    		    ...
	    		    protected Map<String, Object> getInsertValues() throws SVNException {
	    		    	Map<String,Object> selectedRow = select.getRowValues();
	    		    	Map<String, Object> insertValues = new HashMap<String, Object>();
	    		    	insertValues.put(NODES__Fields.wc_id.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.wc_id.toString()));
	    		    	insertValues.put(NODES__Fields.local_relpath.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.local_relpath.toString()));
	    		    	insertValues.put(NODES__Fields.op_depth.toString(), 2);
	    		    	insertValues.put(NODES__Fields.parent_relpath.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.parent_relpath.toString()));
	    		    	insertValues.put(NODES__Fields.repos_id.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.copyfrom_repos_id.toString()));
	    		    	insertValues.put(NODES__Fields.repos_path.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.copyfrom_repos_path.toString()));
	    		    	insertValues.put(NODES__Fields.revision.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.copyfrom_revnum.toString()));
	    		    	insertValues.put(NODES__Fields.presence.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.presence.toString()));
	    		    	insertValues.put(NODES__Fields.depth.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.depth.toString()));
	    		    	insertValues.put(NODES__Fields.moved_here.toString(), null);
	    		    	insertValues.put(NODES__Fields.moved_to.toString(), null);
	    		    	insertValues.put(NODES__Fields.kind.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.kind.toString()));
	    		    	insertValues.put(NODES__Fields.changed_revision.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.changed_rev.toString()));
	    		    	insertValues.put(NODES__Fields.changed_date.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.changed_date.toString()));
	    		    	insertValues.put(NODES__Fields.changed_author.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.changed_author.toString()));
	    		    	insertValues.put(NODES__Fields.checksum.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.checksum.toString()));
	    		    	insertValues.put(NODES__Fields.properties.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.properties.toString()));
	    		    	insertValues.put(NODES__Fields.translated_size.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.translated_size.toString()));
	    		    	insertValues.put(NODES__Fields.last_mod_time.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.last_mod_time.toString()));
	    		    	insertValues.put(NODES__Fields.dav_cache.toString(), null);
	    		    	insertValues.put(NODES__Fields.symlink_target.toString(), selectedRow.get(SVNWCDbSchema.WORKING_NODE__Fields.symlink_target.toString()));
	    		    	insertValues.put(NODES__Fields.file_external.toString(), null);
	    		    	return insertValues;
	    		    }
    	...
    	public void bumpTo(SVNWCDb db, SVNSqlJetDb sDb, File wcRootAbsPath) throws SVNException {
	        ...
	        */
	        SVNSqlJetUpdateStatement stmt = new SVNSqlJetUpdateStatement(sDb, SVNWCDbSchema.ACTUAL_NODE) {
	            public Map<String, Object> getUpdateValues() throws SVNException {
	                Map<String, Object> rowValues = getRowValues();
	                rowValues.put(ACTUAL_NODE__Fields.tree_conflict_data.toString(),
	                        rowValues.get(ACTUAL_NODE__Fields.conflict_data.toString()));
	                return rowValues;
	            }
	        };
	        try {
	        ...
	        stmt = new SVNSqlJetUpdateStatement(sDb, SVNWCDbSchema.ACTUAL_NODE) {
	            public Map<String, Object> getUpdateValues() throws SVNException {
	                Map<String, Object> rowValues = getRowValues();
	                rowValues.put(ACTUAL_NODE__Fields.conflict_data.toString(), null);
	                return rowValues;
	            }
	        };
	        try {
    ...
    private static class bumpTo23 implements Bumpable {
    	public void bumpTo(SVNWCDb db, SVNSqlJetDb sDb, File wcRootAbsPath) throws SVNException {
	        ...
	        //LIMIT 1
	        SVNSqlJetSelectFieldsStatement<NODES__Fields> stmt = new SVNSqlJetSelectFieldsStatement<NODES__Fields>(sDb, SVNWCDbSchema.NODES) {
	            protected void defineFields() {
	                fields.add(NODES__Fields.wc_id);
	            }
	            protected boolean isFilterPassed() throws SVNException {
    	...
    	public void bumpTo(SVNWCDb db, SVNSqlJetDb sDb, File wcRootAbsPath) throws SVNException {
	    	...
	    	*/
	    	SVNSqlJetUpdateStatement stmt = new SVNSqlJetUpdateStatement(sDb, SVNWCDbSchema.PRISTINE) {
	    		private SVNSqlJetSelectFieldsStatement<NODES__Fields> select =
	    				new SVNSqlJetSelectFieldsStatement<NODES__Fields>(sDb, SVNWCDbSchema.NODES) {
	    					protected boolean isFilterPassed() throws SVNException {
	    						return ((String)getBind(1)).equals(getColumnString(NODES__Fields.checksum));
	    					}
	    					protected void defineFields() {
	    		                fields.add(NODES__Fields.wc_id);
	    		            }
    ...
    private static class bumpTo27 implements Bumpable {
	    public void bumpTo(SVNWCDb db, SVNSqlJetDb sDb, File wcRootAbsPath) throws SVNException {
	    	...
	    	*/
	    	  ...
	    	  SVNSqlJetSelectFieldsStatement<ACTUAL_NODE__Fields> stmt = new SVNSqlJetSelectFieldsStatement<ACTUAL_NODE__Fields>(sDb, SVNWCDbSchema.ACTUAL_NODE) {
	              protected void defineFields() {
	                  fields.add(ACTUAL_NODE__Fields.wc_id);
	              }
	              protected boolean isFilterPassed() throws SVNException {
	            	  return !(isColumnNull(ACTUAL_NODE__Fields.prop_reject) &&
	            			  isColumnNull(ACTUAL_NODE__Fields.conflict_old) &&
	            			  isColumnNull(ACTUAL_NODE__Fields.conflict_new) &&
	            			  isColumnNull(ACTUAL_NODE__Fields.conflict_working) &&
	            			  isColumnNull(ACTUAL_NODE__Fields.tree_conflict_data));
	              }
	          };
    ...
    private static void upgradeExternals(SVNSqlJetDb sDb, File wcRootAbsPath) throws SVNException {
    	...
    	try {
            while (stmt.next()) {
            	SVNProperties props = stmt.getColumnProperties(NODES__Fields.properties);
            	String externalsValues = props.getStringValue(SVNProperty.EXTERNALS);
            	File localRelPath = SVNFileUtil.createFilePath(stmt.getColumnString(NODES__Fields.properties));
